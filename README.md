# crescer
Projeto de loja de brinquedos infantis.
...
4. Integração com Banco de Dados: Persistência de dados eficiente e escalável.
   
 O projeto permite, de forma simples, a intereção do back-end, front-end e do banco de dados por meio de tecnologias como:
   1. Java
   2. Fluter Flow
   3. Render
   4. Swagger
